...
AI21_API_KEY = os.getenv("AI21_API_KEY","your-api-key-here")
...
def llm(prompt, model_choice):
    ...
    elif model_choice.startswith('ai21/'):
        out = single_message_instruct(prompt,model=model_choice.split('/')[-1])
...
def evaluate_relevance(question, answer):
    ...
    evaluation, tokens, _ = llm(prompt, 'ai21/jamba-1.5-mini')
